...
tree::TerminalNode* CypherParser::OC_NullOperatorExpressionContext::NULL() {
...
tree::TerminalNode* CypherParser::OC_LiteralContext::NULL() {
  return getToken(CypherParser::NULL, 0);
}
...
tree::TerminalNode* CypherParser::OC_ReservedWordContext::NULL() {
  return getToken(CypherParser::NULL, 0);
}
